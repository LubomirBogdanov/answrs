...
.LVL1:
	mov	r3, r0
	mov	r4, r1
	.loc 1 39 18 discriminator 3
	lsls	r2, r5, #3
	add	r1, r7, #248
	add	r2, r2, r1
	subs	r2, r2, #240
	strd	r3, [r2]
	.loc 1 38 22 discriminator 3
	ldr	r3, [r7, #4]
	adds	r3, r3, #1
	str	r3, [r7, #4]
.L2:
...
.L5:
	...
	ldr	r0, .L11+16
	bl	printf_
	.loc 1 45 22 discriminator 3
	ldr	r3, [r7, #4]
	adds	r3, r3, #1
	str	r3, [r7, #4]
.L4:
	.loc 1 45 15 discriminator 1
	ldr	r3, [r7, #4]
...
.LASF22:
	.ascii	"char\000"
.LASF124:
	.ascii	"my_fpu_array_1\000"
.LASF125:
	.ascii	"my_fpu_array_2\000"
.LASF31:
	.ascii	"__tm_min\000"
.LASF95:
	.ascii	"_mult\000"
