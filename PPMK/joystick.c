...
int main(void) {
    ...
    Graphics_drawStringCentered(&g_sContext, (int8_t *)"JOYSTICK", AUTO_STRING_LENGTH, 64, 10, OPAQUE_TEXT);
    ...
    adc_memory_struct.inputSourceSelect = ADC12_B_INPUT_A4;
    ...
    adc_memory_struct.inputSourceSelect = ADC12_B_INPUT_A10;
    adc_memory_struct.refVoltageSourceSelect = ADC12_B_VREFPOS_AVCC_VREFNEG_VSS;
    ...
    ADC12_B_enableInterrupt(ADC12_B_BASE, ADC12_B_IE0 | ADC12_B_IE1, 0, 0);    // Enable memory buffer 0 interrupt
    ...
    {
        __enable_interrupt();
    	__bis_SR_register(CPUOFF + GIE); //Awoken by adc, gpio
    	__disable_interrupt();
