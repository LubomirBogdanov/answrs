...
void main( void )
{
  ...
  TB0CCR0 = 1000;       // PWM период, 1000 us = 1 ms, 1 kHz, Userguide -> стр. 669

  //TB0CCR5 = 50;        // PWM коефициент на запълване 5%, Userguide -> стр. 669
  //TB0CCR5 = 250;        // PWM коефициент на запълване 25%, Userguide -> стр. 669
  TB0CCR5 = 750;        // PWM коефициент на запълване 75%, Userguide -> стр. 669
